...
- **Reparaciones (admin):** el menú **Reparaciones** muestra los equipos que siguen en taller **hasta hoy**, de todas las sucursales. Si una recepción vieja quedó solo en el ticket (sin ficha), se reconstruye y no se pierde. El **precio al cliente** se captura ahí (el saldo se recalcula contra el anticipo ya cobrado). Los **costos internos** (refacción, mano de obra u otro) se anotan en el mismo folio y no entran al Corte X: viven en el tab **Finanzas**, con la semana actual (lunes a domingo, hora Sonora) y el historial semanal (cobrado, costos, margen, recibidos y entregados). El cobro de anticipo o liquidación sigue en el punto de venta y en caja.
