...
- **CREDICEL Dashboard:** (admin y encargado) tablero tipo Drive para notas y archivos. Se ve en recuadros o en lista. El botón **+** abre una nota con texto, recuadros para marcar, tachado y documentos adjuntos con título.
