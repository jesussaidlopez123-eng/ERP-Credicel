...
- **CREDICEL Dashboard:** (admin y encargado) notas al estilo Keep. Cada nota se puede **Fijar** o **No fijar**. Los archivos van abajo, en lista, con una miniatura pequeña.
