...
- **CREDICEL Dashboard:** (admin y encargado) notas al estilo Keep. Cada nota se puede **Fijar** o **No fijar**. Se ven en recuadros o lista, y cada archivo cargado aparece como ficha visual (foto, PDF o icono), no solo el nombre.
