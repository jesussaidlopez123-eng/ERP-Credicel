...
- **Dirección:** primer módulo del menú (admin). Arriba va el recuadro de la semana elegida, con columnas Matriz, Navojoa, Huatabampo y Totales. Ahí se ven todos los productos (accesorios, reparaciones, comisiones, gastos, equipos cobrados, abonos y recargas). En Totales, al final se resta lo que se retorna (equipos + abonos + recargas) para llegar a la utilidad: accesorios + reparaciones + comisiones − gastos. Debajo hay recuadros chicos por semana natural ISO (lunes a domingo, hora Sonora), con el rango de calendario y las fechas en que sí hubo tickets o gastos. Comisión: Matriz y Navojoa $1,000 por celular, Huatabampo $350 por celular.
