...
- **CREDICEL Dashboard:** (admin y encargado) notas al estilo Keep. Cada nota se puede **Fijar** o **No fijar**, o convertir en **lista de tareas** (lo marcado baja al final). Los archivos van abajo, en lista, con una miniatura pequeña.
...
Roles: **Administrador** (todo el menú), **Encargado** (punto de venta, inventario, ventas, cortes y CREDICEL Dashboard) y **Cajero** (solo punto de venta).
